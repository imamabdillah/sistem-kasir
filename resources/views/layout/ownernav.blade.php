                ...
                <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                    ...
                    <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
                        ...
                        <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('owner.dashboard') }}">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('owner.datamenu') }}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs014.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('tenantinfos.index') }}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs014.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <span class="menu-title px-2">Tenant Info</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                ...
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title px-w">User Management</span>
                                ...
                                <div class="menu-sub menu-sub-accordion px-4">
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="{{ route('owner.kasir.index') }}">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('owner.transaksi') }}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs014.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                ...
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title px-w">Presensi</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <!--end:Menu item-->
                                <div class="menu-sub menu-sub-accordion px-4">
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="{{ route('owner.presensimasuk') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                ...
                                <div class="menu-sub menu-sub-accordion px-4">
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="{{ route('owner.presensikeluar') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
