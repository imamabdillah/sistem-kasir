...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true"
    ...
    <div class="d-flex flex-column flex-column-fluid">
        <form method="POST" action="{{ route('tenantinfos.store') }}" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="required form-label" for="tenant">Pilih Tenant</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select class="form-select @error('tenant') is-invalid @enderror" id="tenant"
                                        ...
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Pilih nama tenant.</div>
                                        <!--end::Description-->
                                    </div>
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea name="deskripsi_umum" class="form-control mb-2" placeholder="Deskripsi Umum"></textarea>
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea name="rekomendasi_menu_a" class="form-control mb-2" placeholder="Rekomendasi Menu A"></textarea>
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea name="rekomendasi_menu_b" class="form-control mb-2" placeholder="Rekomendasi Menu B"></textarea>
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea name="deskripsi_tenant" class="form-control mb-2" placeholder="Deskripsi Tenant"></textarea>
                                        <!--end::Input-->
                                        <!--begin::Description-->
